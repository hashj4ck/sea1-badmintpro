...
public class Teilnehmer {
	...
	private BooleanProperty _hatBezahlt;
	private StringProperty _email;

	/**
	 * Erzeugt einen neuen Teilnehmer mit Vor-und Nachnamen, Emailadresse und
	 * id.
	 * 
	 * @param vorname
	 ...
	 * @param email
	 *            die Emailadresse des Teilnehmers
	 * 
	 */
	public Teilnehmer(String vorname, String nachname, String email, int id) {
		...
		_hatBezahlt = new SimpleBooleanProperty(false);
	 ...
	 */
	public void bezahlt(boolean bool) {
		_hatBezahlt.set(bool);
	}
