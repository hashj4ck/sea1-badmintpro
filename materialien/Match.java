...
public class Match
{
     ...
     * Anzahl der Siege des besseren Teams erhöht. Setzt das Endergebnis auf einen
     * beschreibenden String.
     * 
     * @param punkteTeam1
     *            die von Team 1 erzielten Punkte
     * @param punkteTeam2
	...
	{
	    _endergebnis
		    .set("Unentschieden zwischen " + _team1 + " und " + _team2);

	}
	if (punkteTeam1 < punkteTeam2)
	{
	    _team2.erhoeheanzahlSiege();
	    _endergebnis.set("" + _team2 + " hat mit " + punkteTeam2 + " zu  "
		    + punkteTeam1 + " gegen " + _team1 + " gewonnen.");

	}
	if (punkteTeam1 > punkteTeam2)
	{
	    _team1.erhoeheanzahlSiege();
	    _endergebnis.set("" + _team1 + " hat mit " + punkteTeam1 + " zu  "
		    + punkteTeam2 + " gegen " + _team2 + " gewonnen.");
	}
