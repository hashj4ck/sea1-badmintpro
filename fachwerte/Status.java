...
public class Status
{
    ...
    public static final StringProperty BESETZT = new SimpleStringProperty(
	    "besetzt");
    public static final StringProperty IN_VORBEREITUNG = new SimpleStringProperty(
	    "in Vorbereitung");
    public static final StringProperty LAUFEND = new SimpleStringProperty(
	    "laufend");
    public static final StringProperty BEENDET = new SimpleStringProperty(
	    "beendet");
